Отлично! Ниже — **пошаговая обучающая программа по принципам SOLID** для C++. Она включает:

* краткое **объяснение каждого принципа**
* **пример кода**
* **проникающие вопросы**, чтобы углубить понимание
